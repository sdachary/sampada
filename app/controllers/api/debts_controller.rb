module Api
  class DebtsController < Api::BaseController
    def index
    ...
    def debt_json(d)
      ...
      progress = d.amount.to_f.positive? ? (d.paid_amount.to_f / d.amount * 100).round(1) : 0.0
      months_remaining = d.emi_amount.to_f.positive? ? (remaining / d.emi_amount.to_f).ceil : 0
      debt_free = months_remaining.positive? ? (Time.zone.today + months_remaining.months) : nil
